...
import org.springframework.http.ResponseEntity;
 ...
 public class ReviewController {
    ...
    @RequestMapping(value = "/reviews/{roomId}", method = RequestMethod.GET)
    public ResponseEntity<Map<String, Object>> getReviews(@PathVariable("roomId") String inRoomId) {
        
		System.out.println("\n\n##### getReviews inRoomId : " + inRoomId + "\n\n");
		long roomId = Long.parseLong(inRoomId);
	...
	@RequestMapping(value = "/mypages.do", method = RequestMethod.POST)
